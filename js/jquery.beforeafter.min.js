...
t.append('<div class="g-img-divider"><span class="ic ic-before-n-after">'+i.message+"</span></div>"),t.on("mouseenter touchstart",function(e){var i=t.data("reset-timer");i&&(window.clearTimeout(i),
